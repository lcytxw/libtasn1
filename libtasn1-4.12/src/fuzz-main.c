...
int
fuzz_main (int argc0, char *argv0[])
{
  ...
  while (1)
    {
      ...
      option_result =
	getopt_long (argc0, argv0, "hvco:n:", long_options, &option_index);
  ...
  if (optind == argc0)
    ...
    {
      inputFileName = (char *) malloc (strlen (argv0[optind]) + 1);
      strcpy (inputFileName, argv0[optind]);
    }
